...
- [ ] 2.2 Implement missing APIs and document limitations
...
- [ ] 2.3 Add tests for Network + IO coverage (see docs/NETWORK_IO_TESTS.md)
...
- [ ] 3.1 Define CLI commands and built-in modules list
- [ ] 3.2 Add compatibility notes and tests

## 4. Tracking and validation
- [ ] 4.1 Add status checklist for implemented/partial/missing
- [ ] 4.2 Add verification criteria per phase
