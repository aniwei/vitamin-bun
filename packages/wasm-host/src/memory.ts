import type { WasmMemoryAccess } from './types.js'

const textEncoder = new TextEncoder()
const textDecoder = new TextDecoder('utf-8')

/**
 * Provides typed read/write access to WASM linear memory.
 * Views are automatically refreshed after memory growth.
 */
export class MemoryAccess implements WasmMemoryAccess {
  ...
  /** Call after any operation that may grow memory (e.g. memory.grow()) */
  refresh(): void {
