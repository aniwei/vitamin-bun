...
function patchAsyncScheduling(stateRef: AsyncHooksState): void {
  ...
  Promise.prototype.then = function then(onFulfilled, onRejected) {
    return originalThen.call(this, wrap(onFulfilled, 'PROMISE'), wrap(onRejected, 'PROMISE'))
  }

  const originalCatch = Promise.prototype.catch
  Promise.prototype.catch = function catchMethod(onRejected) {
    return originalCatch.call(this, wrap(onRejected, 'PROMISE'))
  }

  const originalFinally = Promise.prototype.finally
  Promise.prototype.finally = function finallyMethod(onFinally) {
    return originalFinally.call(this, wrap(onFinally, 'PROMISE'))
  }
}
