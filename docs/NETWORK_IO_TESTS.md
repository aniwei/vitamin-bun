...
| fetch | unsupported options + preconnect warnings | packages/browser-runtime/src/__tests__/fetch-warnings.test.ts | partial |
| WebSocket | WS proxy behavior | packages/network-proxy/src/__tests__/websocket-proxy.test.ts | partial |
| Bun.file | text/json/arrayBuffer/bytes/stream/delete | packages/bunts-runtime/src/__tests__/bun-file-write.test.ts | partial |
| Bun.write | string/bytes/Response/Blob/ReadableStream/FileSink | packages/bunts-runtime/src/__tests__/bun-file-write.test.ts | partial |
